...
import { signupUserRequest } from "@/services/onboarding/requests";
...
const SignUp = () => {
  ...
  const { mutate: signupMutation, isPending } = useMutation({
    ...
    onSuccess: (response) => {
      ...
      setSessionStorage("userId", response.data.userId);
      navigate("/onboarding/auth/confirm-otp", {
        state: {
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    signupMutation({ firstName, lastName, email, password, role });
  };
